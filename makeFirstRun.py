...
year = arguments[2]
beforeYear = str(int(arguments[2])-1)
...
fileContent = '''
 ...
 TIMEZONE        = 'UTC',
 DATE_FORMAT     = 'YMD'
 START_DATE      = '{1}-12-26 00:00:00'
 END_DATE        = '{2}-02-01 00:00:00'
 /
 ...
 &NML_RESTART
 RST_ON  = T,
 RST_FIRST_OUT      = '{2}-01-01 00:00:00'
...
'''.format(gridName, beforeYear, year)
